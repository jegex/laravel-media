# This is my package laravel-media
...
[![GitHub Tests Action Status](https://img.shields.io/github/actions/workflow/status/jegex/laravel-media/run-tests.yml?branch=main&label=tests&style=flat-square)](https://github.com/jegex/laravel-media/actions?query=workflow%3Arun-tests+branch%3Amain)
[![GitHub Code Style Action Status](https://img.shields.io/github/actions/workflow/status/jegex/laravel-media/fix-php-code-style-issues.yml?branch=main&label=code%20style&style=flat-square)](https://github.com/jegex/laravel-media/actions?query=workflow%3A"Fix+PHP+code+style+issues"+branch%3Amain)
...
```php
$laravelMedia = new Jegex\LaravelMedia();
echo $laravelMedia->echoPhrase('Hello, Jegex!');
```
