...
use Jegex\Media\Support\FileRemover\DefaultFileRemover;
...
return [
    ...
    /*
     * Enable route for Media Library Pro Vue/React components when using Laravel Vapor.
     */
    'enable_vapor_uploads' => env('ENABLE_MEDIA_LIBRARY_VAPOR_UPLOADS', false),

    /*
     * The route prefix for Vapor uploads.
     */
    'vapor_route_prefix' => 'media-vapor',

    /*
     * The middleware for Vapor upload routes.
     */
